...
class BlockchainValidator():
    ...
    def valid_block(self, block, chain):
        ...
        if self._valid_chain(chain, service_data) is False:
            return False
    ...
    def _valid_chain(self, chain, service_data):
        ...
        for block in chain[1:]:
            if self._valid_block(block, service_data) is False:
                return False
    ...
    def _valid_block(self, block, service_data):
        ...
        for transaction in block['data']['transactions']:
            if self._valid_transaction(transaction, service_data) is False:
                return False
